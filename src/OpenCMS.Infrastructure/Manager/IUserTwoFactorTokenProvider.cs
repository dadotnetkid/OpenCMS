...
{  /// <summary>
   ...
   /// <typeparam name="TUser">The type encapsulating a user.</typeparam>
    public interface IUserTwoFactorTokenProvider<TUser> where TUser : class
    {
        ...
        /// </remarks>
        Task<string> GenerateAsync(string purpose, ApplicationUserManager<TUser> manager, TUser user);
        ...
        /// </returns>
        Task<bool> ValidateAsync(string purpose, string token, ApplicationUserManager<TUser> manager, TUser user);
        ...
        /// </returns>
        Task<bool> CanGenerateTwoFactorTokenAsync(ApplicationUserManager<TUser> manager, TUser user);
    }
}
