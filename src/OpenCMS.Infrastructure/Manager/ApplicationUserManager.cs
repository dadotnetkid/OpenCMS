...
{
    public class ApplicationUserManager<TUser>:IDisposable where TUser:class
    {
        ...
        public virtual IQueryable<TUser> Users
        {
            get
            {
                ...
                {
                    throw new NotSupportedException(nameof(Users));
                }
        ...
        public virtual async Task<bool> VerifyUserTokenAsync(TUser user, string tokenProvider, string purpose, string token)
        {
            ...
            {
                throw new NotSupportedException(nameof(tokenProvider));
            }
        ...
        private IUserTwoFactorStore<TUser> GetUserTwoFactorStore()
        {
            ...
            if (cast == null)
            {
                throw new NotSupportedException(nameof(GetUserTwoFactorStore));
            }
            return cast;
        }
        ...
        private IUserLoginStore<TUser> GetLoginStore()
        {
            ...
            if (cast == null)
            {
                throw new NotSupportedException("StoreNotIUserLoginStore");
            }
            return cast;
        }
        ...
        private IUserAuthenticatorKeyStore<TUser> GetAuthenticatorKeyStore()
        {
            ...
            if (cast == null)
            {
                throw new NotSupportedException("StoreNotIUserAuthenticatorKeyStore");
            }
            return cast;
        }
        ...
        private IUserTwoFactorRecoveryCodeStore<TUser> GetRecoveryCodeStore()
        {
            ...
            if (cast == null)
            {
                throw new NotSupportedException("StoreNotIUserTwoFactorRecoveryCodeStore");
            }
            return cast;
        }
        ...
        private IUserAuthenticationTokenStore<TUser> GetAuthenticationTokenStore()
        {
            ...
            if (cast == null)
            {
                throw new NotSupportedException("StoreNotIUserAuthenticationTokenStore");
            }
            return cast;
        }
